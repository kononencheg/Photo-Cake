...
function $tuna$dom$addOneEventListener$$($element$$13$$, $type$$53$$, $handler$$7$$) {
  function $listener$$27$$($event$$6_handler$$inline_12$$) {
    ...
    var $element$$inline_10_handlers$$inline_405$$ = $element$$13$$, $i$$inline_406_type$$inline_11$$ = $type$$53$$, $event$$6_handler$$inline_12$$ = $listener$$27$$;
    if($element$$inline_10_handlers$$inline_405$$.removeEventListener !== $JSCompiler_alias_VOID$$) {
      $element$$inline_10_handlers$$inline_405$$.removeEventListener($i$$inline_406_type$$inline_11$$, $event$$6_handler$$inline_12$$, $JSCompiler_alias_FALSE$$)
    }else {
      if($element$$inline_10_handlers$$inline_405$$.detachEvent !== $JSCompiler_alias_VOID$$) {
        if($element$$inline_10_handlers$$inline_405$$["on" + $i$$inline_406_type$$inline_11$$] === $JSCompiler_alias_VOID$$) {
          if($element$$inline_10_handlers$$inline_405$$ = $element$$inline_10_handlers$$inline_405$$["__" + $i$$inline_406_type$$inline_11$$], $element$$inline_10_handlers$$inline_405$$ !== $JSCompiler_alias_VOID$$) {
            for($i$$inline_406_type$$inline_11$$ = $element$$inline_10_handlers$$inline_405$$.length - 1;0 <= $i$$inline_406_type$$inline_11$$;) {
              $element$$inline_10_handlers$$inline_405$$[$i$$inline_406_type$$inline_11$$] === $event$$6_handler$$inline_12$$ && $element$$inline_10_handlers$$inline_405$$.splice($i$$inline_406_type$$inline_11$$, 1), $i$$inline_406_type$$inline_11$$--
            }
          }
        }else {
          $element$$inline_10_handlers$$inline_405$$.detachEvent("on" + $i$$inline_406_type$$inline_11$$, $event$$6_handler$$inline_12$$)
        }
      }
    }
  }
  ...
  if(this.$__hasEvent$) {
    ...
    setTimeout(function() {
      for(var $i$$inline_59$$ = $self$$3$$.$_nodes$.length - 1;0 <= $i$$inline_59$$;) {
        var $element$$inline_408$$ = $self$$3$$.$_nodes$[$i$$inline_59$$], $type$$inline_409$$ = $self$$3$$.$__eventName$, $data$$inline_410_eventName$$inline_413$$ = "" + $value$$46$$, $doc$$inline_411$$ = $element$$inline_408$$.ownerDocument, $event$$inline_412_event$$inline_414$$ = $JSCompiler_alias_NULL$$;
        $doc$$inline_411$$.createEventObject !== $JSCompiler_alias_VOID$$ ? ($event$$inline_412_event$$inline_414$$ = $doc$$inline_411$$.createEventObject(), $data$$inline_410_eventName$$inline_413$$ && ($event$$inline_412_event$$inline_414$$.data = $data$$inline_410_eventName$$inline_413$$), $data$$inline_410_eventName$$inline_413$$ = "on" + $type$$inline_409$$, $element$$inline_408$$[$data$$inline_410_eventName$$inline_413$$] === $JSCompiler_alias_VOID$$ ? ($event$$inline_412_event$$inline_414$$.$__type$ = 
        $type$$inline_409$$, $element$$inline_408$$.fireEvent("onhelp", $event$$inline_412_event$$inline_414$$)) : $element$$inline_408$$.fireEvent($data$$inline_410_eventName$$inline_413$$, $event$$inline_412_event$$inline_414$$)) : ($event$$inline_412_event$$inline_414$$ = document.createEvent("UIEvents"), $event$$inline_412_event$$inline_414$$.initUIEvent($type$$inline_409$$, $JSCompiler_alias_TRUE$$, $JSCompiler_alias_TRUE$$, window, 1), $data$$inline_410_eventName$$inline_413$$ && ($event$$inline_412_event$$inline_414$$.data = 
        $data$$inline_410_eventName$$inline_413$$), $element$$inline_408$$.dispatchEvent($event$$inline_412_event$$inline_414$$));
        $i$$inline_59$$--
      }
    }, 0)
  }
...
$JSCompiler_prototypeAlias$$.init = function $$JSCompiler_prototypeAlias$$$init$() {
  ...
  $tuna$dom$addEventListener$$(this.$_target$, "submit", function($event$$19$$) {
    $self$$8$$.isEnabled() ? ($callbackInput$$.value = "form_callback" + (Math.random() + "").substr(2), window[$callbackInput$$.value] = function $window$$callbackInput$$$value$($data$$inline_162_errors$$inline_164_response$$) {
      var $data$$inline_162_errors$$inline_164_response$$ = JSON.parse(JSON.stringify($data$$inline_162_errors$$inline_164_response$$)), $i$$inline_424_response$$inline_163$$ = $data$$inline_162_errors$$inline_164_response$$.response, $data$$inline_162_errors$$inline_164_response$$ = $data$$inline_162_errors$$inline_164_response$$.errors;
      if($i$$inline_424_response$$inline_163$$ !== $JSCompiler_alias_VOID$$) {
        $self$$8$$.$__recordName$ !== $JSCompiler_alias_NULL$$ && ($i$$inline_424_response$$inline_163$$ = $tuna$rest$populateRecords$$($i$$inline_424_response$$inline_163$$, $self$$8$$.$__recordName$)), $self$$8$$.$dispatch$("result", $i$$inline_424_response$$inline_163$$)
      }else {
        if($data$$inline_162_errors$$inline_164_response$$ !== $JSCompiler_alias_VOID$$) {
          for(var $i$$inline_424_response$$inline_163$$ = 0, $l$$inline_425$$ = $data$$inline_162_errors$$inline_164_response$$.length, $error$$inline_426_name$$inline_460$$ = $JSCompiler_alias_NULL$$;$i$$inline_424_response$$inline_163$$ < $l$$inline_425$$;) {
            $error$$inline_426_name$$inline_460$$ = $data$$inline_162_errors$$inline_164_response$$[$i$$inline_424_response$$inline_163$$];
            if($error$$inline_426_name$$inline_460$$.param !== $JSCompiler_alias_VOID$$) {
              var $JSCompiler_StaticMethods___showInputError$self$$inline_427_JSCompiler_StaticMethods_showErrorMessage$self$$inline_465$$ = $self$$8$$, $message$$inline_428_message$$inline_466$$ = $error$$inline_426_name$$inline_460$$.message, $JSCompiler_StaticMethods___getFormInput$self$$inline_459_formInput$$inline_429$$;
              $JSCompiler_StaticMethods___getFormInput$self$$inline_459_formInput$$inline_429$$ = $JSCompiler_StaticMethods___showInputError$self$$inline_427_JSCompiler_StaticMethods_showErrorMessage$self$$inline_465$$;
              var $error$$inline_426_name$$inline_460$$ = $error$$inline_426_name$$inline_460$$.param, $result$$inline_461$$ = $JSCompiler_alias_NULL$$;
              if($JSCompiler_StaticMethods___getFormInput$self$$inline_459_formInput$$inline_429$$.$__inputTable$[$error$$inline_426_name$$inline_460$$] === $JSCompiler_alias_VOID$$) {
                var $input$$inline_463_inputWrapper$$inline_462$$ = $tuna$dom$selectOne$$(".j-" + $error$$inline_426_name$$inline_460$$ + "-input", $JSCompiler_StaticMethods___getFormInput$self$$inline_459_formInput$$inline_429$$.$_target$);
                $input$$inline_463_inputWrapper$$inline_462$$ !== $JSCompiler_alias_NULL$$ && ($input$$inline_463_inputWrapper$$inline_462$$ = new $tuna$ui$forms$FormInput$$($input$$inline_463_inputWrapper$$inline_462$$), $input$$inline_463_inputWrapper$$inline_462$$.init(), $JSCompiler_StaticMethods___getFormInput$self$$inline_459_formInput$$inline_429$$.$__inputTable$[$error$$inline_426_name$$inline_460$$] = $input$$inline_463_inputWrapper$$inline_462$$)
              }
              $JSCompiler_StaticMethods___getFormInput$self$$inline_459_formInput$$inline_429$$.$__inputTable$[$error$$inline_426_name$$inline_460$$] !== $JSCompiler_alias_VOID$$ && ($result$$inline_461$$ = $JSCompiler_StaticMethods___getFormInput$self$$inline_459_formInput$$inline_429$$.$__inputTable$[$error$$inline_426_name$$inline_460$$]);
              $JSCompiler_StaticMethods___getFormInput$self$$inline_459_formInput$$inline_429$$ = $result$$inline_461$$;
              $JSCompiler_StaticMethods___getFormInput$self$$inline_459_formInput$$inline_429$$ !== $JSCompiler_alias_NULL$$ ? ($JSCompiler_StaticMethods___showInputError$self$$inline_427_JSCompiler_StaticMethods_showErrorMessage$self$$inline_465$$ = $JSCompiler_StaticMethods___getFormInput$self$$inline_459_formInput$$inline_429$$, $tuna$dom$addClass$$($JSCompiler_StaticMethods___showInputError$self$$inline_427_JSCompiler_StaticMethods_showErrorMessage$self$$inline_465$$.$_target$, "error"), $JSCompiler_StaticMethods___showInputError$self$$inline_427_JSCompiler_StaticMethods_showErrorMessage$self$$inline_465$$.$__message$ !== 
              $JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods___showInputError$self$$inline_427_JSCompiler_StaticMethods_showErrorMessage$self$$inline_465$$.$__message$.innerHTML = $message$$inline_428_message$$inline_466$$)) : $JSCompiler_StaticMethods___showErrorMessage$$($JSCompiler_StaticMethods___showInputError$self$$inline_427_JSCompiler_StaticMethods_showErrorMessage$self$$inline_465$$, $message$$inline_428_message$$inline_466$$)
            }else {
              $JSCompiler_StaticMethods___showErrorMessage$$($self$$8$$, $error$$inline_426_name$$inline_460$$.message)
            }
            $i$$inline_424_response$$inline_163$$++
          }
...
function $JSCompiler_StaticMethods___prepareTo$$($JSCompiler_StaticMethods___prepareTo$self$$, $JSCompiler_StaticMethods_cleanup$self$$inline_431_type$$73$$, $event$$21$$) {
  if($JSCompiler_StaticMethods___prepareTo$self$$.$dispatch$($JSCompiler_StaticMethods_cleanup$self$$inline_431_type$$73$$)) {
    ...
    for(var $name$$inline_169$$ in $JSCompiler_StaticMethods___prepareTo$self$$.$__inputTable$) {
      $JSCompiler_StaticMethods_cleanup$self$$inline_431_type$$73$$ = $JSCompiler_StaticMethods___prepareTo$self$$.$__inputTable$[$name$$inline_169$$], $tuna$dom$removeClass$$($JSCompiler_StaticMethods_cleanup$self$$inline_431_type$$73$$.$_target$, "error"), $JSCompiler_StaticMethods_cleanup$self$$inline_431_type$$73$$.$__message$ !== $JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods_cleanup$self$$inline_431_type$$73$$.$__message$.innerHTML = $JSCompiler_StaticMethods_cleanup$self$$inline_431_type$$73$$.$__defaultMessage$)
    }
  }else {
...
$Navigation$$.prototype.init = function $$Navigation$$$$init$() {
  ...
  var $buttonSelector$$inline_203_buttons$$inline_205_currentIndex$$inline_211_itemsCollection$$inline_198$$ = new $tuna$ui$selection$items$NamedElementsCollection$$("data-name"), $i$$inline_206_menu$$inline_204_menuSelector$$inline_202_selectionView$$inline_199$$ = new $tuna$ui$selection$view$ClassSelectionView$$(this.$_target$), $className$$inline_434_l$$inline_207_selector$$inline_437$$ = $JSCompiler_StaticMethods_getStringOption$$(this, "selection-class");
  $i$$inline_206_menu$$inline_204_menuSelector$$inline_202_selectionView$$inline_199$$.$_selectionClass$ = $className$$inline_434_l$$inline_207_selector$$inline_437$$;
  $className$$inline_434_l$$inline_207_selector$$inline_437$$ = $JSCompiler_StaticMethods_getStringOption$$(this, "item-selector");
  $i$$inline_206_menu$$inline_204_menuSelector$$inline_202_selectionView$$inline_199$$.$_itemSelector$ = $className$$inline_434_l$$inline_207_selector$$inline_437$$;
  ...
  $JSCompiler_alias_NULL$$)) {
    for(var $buttonSelector$$inline_203_buttons$$inline_205_currentIndex$$inline_211_itemsCollection$$inline_198$$ = $tuna$dom$select$$($buttonSelector$$inline_203_buttons$$inline_205_currentIndex$$inline_211_itemsCollection$$inline_198$$, $i$$inline_206_menu$$inline_204_menuSelector$$inline_202_selectionView$$inline_199$$), $i$$inline_206_menu$$inline_204_menuSelector$$inline_202_selectionView$$inline_199$$ = 0, $className$$inline_434_l$$inline_207_selector$$inline_437$$ = $buttonSelector$$inline_203_buttons$$inline_205_currentIndex$$inline_211_itemsCollection$$inline_198$$.length, 
    $href$$inline_208_index$$inline_209$$ = $JSCompiler_alias_NULL$$, $button$$inline_210$$ = $href$$inline_208_index$$inline_209$$ = $JSCompiler_alias_NULL$$;$i$$inline_206_menu$$inline_204_menuSelector$$inline_202_selectionView$$inline_199$$ < $className$$inline_434_l$$inline_207_selector$$inline_437$$;) {
...
function $JSCompiler_StaticMethods___initControls$$($JSCompiler_StaticMethods___initControls$self$$) {
  ...
  $controls$$.addEventListener("navigate", function($event$$25$$, $button$$2$$) {
    ...
    if($index$$67$$ !== $JSCompiler_alias_NULL$$) {
      var $prefix$$inline_449$$;
      $prefix$$inline_449$$ === $JSCompiler_alias_VOID$$ && ($prefix$$inline_449$$ = "data-");
      for(var $result$$inline_450$$ = {}, $attrs$$inline_451$$ = $button$$2$$.$_target$.attributes, $i$$inline_452$$ = 0, $l$$inline_453$$ = $attrs$$inline_451$$.length;$i$$inline_452$$ < $l$$inline_453$$;) {
        0 === $attrs$$inline_451$$[$i$$inline_452$$].name.indexOf($prefix$$inline_449$$) && ($result$$inline_450$$[$attrs$$inline_451$$[$i$$inline_452$$].name.substr($prefix$$inline_449$$.length)] = $attrs$$inline_451$$[$i$$inline_452$$].value), $i$$inline_452$$++
      }
      delete $result$$inline_450$$.href;
      $JSCompiler_StaticMethods___initControls$self$$.navigate($index$$67$$, $result$$inline_450$$)
    }
  });
...
$Order$$.prototype.$serialize$ = function $$Order$$$$$serialize$$() {
  var $decorationPrice_price$$inline_366$$;
  $decorationPrice_price$$inline_366$$ = 0;
  if(this.$cake$ !== $JSCompiler_alias_NULL$$) {
    var $deco$$inline_367_recipePrice$$ = this.$cake$.$__markupJson$.content.deco !== $JSCompiler_alias_VOID$$ ? this.$cake$.$__markupJson$.content.deco : $JSCompiler_alias_NULL$$;
    if($deco$$inline_367_recipePrice$$ !== $JSCompiler_alias_NULL$$) {
      for(var $deliveryPrice_i$$inline_368$$ = 0, $l$$inline_369$$ = $deco$$inline_367_recipePrice$$.length;$deliveryPrice_i$$inline_368$$ < $l$$inline_369$$;) {
        $decorationPrice_price$$inline_366$$ += this.$bakery$.$decorationPrices$[$deco$$inline_367_recipePrice$$[$deliveryPrice_i$$inline_368$$].name], $deliveryPrice_i$$inline_368$$++
      }
    }
  }
  $deco$$inline_367_recipePrice$$ = this.$recipe$ !== $JSCompiler_alias_NULL$$ && this.$cake$ !== $JSCompiler_alias_NULL$$ ? $JSCompiler_StaticMethods_getWeightPrice$$(this.$recipe$, this.$cake$.$dimension$.$weight$) : 0;
  $deliveryPrice_i$$inline_368$$ = this.$bakery$ !== $JSCompiler_alias_NULL$$ ? this.$bakery$.$deliveryPrice$ : 0;
  return{cake:$tuna$model$serialize$$(this.$cake$), recipe:$tuna$model$serialize$$(this.$recipe$), bakery:$tuna$model$serialize$$(this.$bakery$), decorationPrice:$decorationPrice_price$$inline_366$$, recipePrice:$deco$$inline_367_recipePrice$$, deliveryPrice:$deliveryPrice_i$$inline_368$$, totalPrice:$decorationPrice_price$$inline_366$$ + $deco$$inline_367_recipePrice$$ + $deliveryPrice_i$$inline_368$$}
};
function $Payment$$() {
...
var $record$$inline_377$$ = new $Decoration$$;
$tuna$model$recordFactory$$.$__records$.decoration = $record$$inline_377$$;
new $ListResource$$("users.getBakeries", "bakery");
new $ListResource$$;
var $model$cakes$$ = new $ListResource$$("cakes.getPromoted", "cake"), $model$dimensions$$ = new $ListResource$$("dimensions.get", "dimension"), $model$decorations$$ = new $ListResource$$("decorations.get", "decoration"), $model$recipes$$ = new $ListResource$$("recipes.get", "recipe"), $model$currentBakery$$ = new $ItemResource$$, $model$currentCake$$ = new $ItemResource$$, $model$currentRecipe$$ = new $ItemResource$$, $model$currentOrder$$ = new $ItemResource$$;
...
$JSCompiler_prototypeAlias$$.$onFlashReady$ = function $$JSCompiler_prototypeAlias$$$$onFlashReady$$() {
  var $JSCompiler_StaticMethods_getMovie$self$$inline_383$$ = this.$__designerSWF$;
  $JSCompiler_StaticMethods_getMovie$self$$inline_383$$.$__movieId$ !== $JSCompiler_alias_NULL$$ && $JSCompiler_StaticMethods_getMovie$self$$inline_383$$.$__movie$ === $JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods_getMovie$self$$inline_383$$.$__movie$ = swfobject.getObjectById($JSCompiler_StaticMethods_getMovie$self$$inline_383$$.$__movieId$));
  this.$__movie$ = $JSCompiler_StaticMethods_getMovie$self$$inline_383$$.$__movie$;
...
var $controller$$inline_389$$ = new $OrderController$$;
$tuna$view$__controllerTable$$.order_step = $controller$$inline_389$$;
function $ResultController$$() {
  $tuna$view$PageViewController$$.call(this);
  this.$_modules$ = ["data-image-copy"]
}
$tuna$utils$extend$$($ResultController$$, $tuna$view$PageViewController$$);
var $controller$$inline_392$$ = new $ResultController$$;
$tuna$view$__controllerTable$$.result_step = $controller$$inline_392$$;
...
var $controller$$inline_395$$ = new $ShareController$$;
$tuna$view$__controllerTable$$.share_step = $controller$$inline_395$$;
function $BakeryMainController$$() {
  $ViewController$$.call(this);
  this.$_modules$ = ["navigation", "template-transformer"]
}
$tuna$utils$extend$$($BakeryMainController$$, $ViewController$$);
...
$tuna$view$__mainController$$ = new $BakeryMainController$$;
})();

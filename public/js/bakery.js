  ...
  $handler$$5$$[$listenerId$$2$$] = function $$handler$$5$$$$listenerId$$2$$$($event$$5_listenerId$$inline_23$$) {
    ...
    if($handler$$5$$[$event$$5_listenerId$$inline_23$$] !== $JSCompiler_alias_VOID$$) {
      ...
      if($element$$12$$.removeEventListener !== $JSCompiler_alias_VOID$$) {
        $element$$12$$.removeEventListener($type$$50$$, $handler$$inline_460$$, $JSCompiler_alias_FALSE$$)
      }else {
        if($element$$12$$.detachEvent !== $JSCompiler_alias_VOID$$) {
          if($element$$12$$["on" + $type$$50$$] === $JSCompiler_alias_VOID$$) {
            var $handlers$$inline_461_listenerId$$inline_463$$ = $element$$12$$["__" + $type$$50$$];
            ...
            $handlers$$inline_461_listenerId$$inline_463$$ = $element$$12$$.$__ieTargetId$ + "_" + $type$$50$$, $handler$$inline_460$$[$handlers$$inline_461_listenerId$$inline_463$$] !== $JSCompiler_alias_VOID$$ && ($element$$12$$.detachEvent("on" + $type$$50$$, $handler$$inline_460$$[$handlers$$inline_461_listenerId$$inline_463$$]), delete $handler$$inline_460$$[$handlers$$inline_461_listenerId$$inline_463$$])
          }
        }
      }
...
$tuna$tmpl$units$Attribute$$.prototype.$__dispatchAttribute$ = function $$tuna$tmpl$units$Attribute$$$$$__dispatchAttribute$$() {
  for(var $i$$23$$ = this.$_nodes$.length - 1;0 <= $i$$23$$;) {
    var $element$$inline_465_element$$inline_77$$ = this.$_nodes$[$i$$23$$], $type$$inline_78$$ = this.$__attributeName$, $event$$inline_466_event$$inline_79$$ = $JSCompiler_alias_NULL$$;
    if(document.createEventObject !== $JSCompiler_alias_VOID$$) {
      var $event$$inline_466_event$$inline_79$$ = document.createEventObject(), $eventName$$inline_80$$ = "on" + $type$$inline_78$$;
      $element$$inline_465_element$$inline_77$$[$eventName$$inline_80$$] === $JSCompiler_alias_VOID$$ ? ($event$$inline_466_event$$inline_79$$.$__type$ = $type$$inline_78$$, $element$$inline_465_element$$inline_77$$.fireEvent("onhelp", $event$$inline_466_event$$inline_79$$)) : $element$$inline_465_element$$inline_77$$.fireEvent($eventName$$inline_80$$, $event$$inline_466_event$$inline_79$$)
    }else {
      $event$$inline_466_event$$inline_79$$ = document.createEvent("UIEvents"), $event$$inline_466_event$$inline_79$$.initUIEvent($type$$inline_78$$, $JSCompiler_alias_TRUE$$, $JSCompiler_alias_TRUE$$, window, 1), $element$$inline_465_element$$inline_77$$.dispatchEvent($event$$inline_466_event$$inline_79$$)
    }
    $i$$23$$--
  }
};
...
$tuna$ui$Module$$.prototype.init = function $$tuna$ui$Module$$$$init$($context$$2$$, $container$$1$$) {
  ...
  for(var $i$$29$$ = 0, $l$$18$$ = $targets_targets$$inline_178$$.length, $instance_target$$inline_181$$ = $JSCompiler_alias_NULL$$;$i$$29$$ < $l$$18$$;) {
    for(var $instance_target$$inline_181$$ = $targets_targets$$inline_178$$[$i$$29$$], $context$$inline_182$$ = $context$$2$$, $JSCompiler_temp$$453_JSCompiler_temp$$454_className$$inline_471_result$$inline_183$$ = $JSCompiler_alias_TRUE$$, $isolators$$inline_184$$ = $tuna$ui$__isolators$$, $i$$inline_185$$ = 0, $l$$inline_186$$ = $isolators$$inline_184$$.length;$i$$inline_185$$ < $l$$inline_186$$;) {
      if($instance_target$$inline_181$$ !== $context$$inline_182$$) {
        if($JSCompiler_temp$$453_JSCompiler_temp$$454_className$$inline_471_result$$inline_183$$ && ($JSCompiler_temp$$453_JSCompiler_temp$$454_className$$inline_471_result$$inline_183$$ = !$tuna$dom$hasClass$$($instance_target$$inline_181$$, $isolators$$inline_184$$[$i$$inline_185$$]))) {
          for(var $JSCompiler_temp$$453_JSCompiler_temp$$454_className$$inline_471_result$$inline_183$$ = $isolators$$inline_184$$[$i$$inline_185$$], $opt_context$$inline_472$$ = $context$$inline_182$$, $parent$$inline_473$$ = $instance_target$$inline_181$$.parentNode;$parent$$inline_473$$ !== $JSCompiler_alias_NULL$$ && $parent$$inline_473$$ !== $opt_context$$inline_472$$ && !$tuna$dom$hasClass$$($parent$$inline_473$$, $JSCompiler_temp$$453_JSCompiler_temp$$454_className$$inline_471_result$$inline_183$$);) {
            $parent$$inline_473$$ = $parent$$inline_473$$.parentNode
          }
          $JSCompiler_temp$$453_JSCompiler_temp$$454_className$$inline_471_result$$inline_183$$ = ($parent$$inline_473$$ === $opt_context$$inline_472$$ ? $JSCompiler_alias_NULL$$ : $parent$$inline_473$$) === $JSCompiler_alias_NULL$$
        }
        if(!$JSCompiler_temp$$453_JSCompiler_temp$$454_className$$inline_471_result$$inline_183$$) {
          break
        }
      }
      $i$$inline_185$$++
    }
    $JSCompiler_temp$$453_JSCompiler_temp$$454_className$$inline_471_result$$inline_183$$ && ($instance_target$$inline_181$$ = this.$initInstance$($targets_targets$$inline_178$$[$i$$29$$], $container$$1$$), $instance_target$$inline_181$$ !== $JSCompiler_alias_NULL$$ && ($instances$$.push($instance_target$$inline_181$$), $JSCompiler_StaticMethods_getBooleanOption$$($instance_target$$inline_181$$, "not-init") || $instance_target$$inline_181$$.init()));
    $i$$29$$++
  }
  return $instances$$
};
...
$JSCompiler_prototypeAlias$$.init = function $$JSCompiler_prototypeAlias$$$init$() {
  ...
  $tuna$dom$addEventListener$$(this.$_target$, "submit", function($event$$21$$) {
    $self$$7$$.isEnabled() ? ($callbackInput$$.value = "form_callback" + (Math.random() + "").substr(2), window[$callbackInput$$.value] = function $window$$callbackInput$$$value$($data$$inline_195_errors$$inline_197_response$$) {
      var $data$$inline_195_errors$$inline_197_response$$ = JSON.parse(JSON.stringify($data$$inline_195_errors$$inline_197_response$$)), $i$$inline_477_response$$inline_196$$ = $data$$inline_195_errors$$inline_197_response$$.response, $data$$inline_195_errors$$inline_197_response$$ = $data$$inline_195_errors$$inline_197_response$$.errors;
      if($i$$inline_477_response$$inline_196$$ !== $JSCompiler_alias_VOID$$) {
        $self$$7$$.$__recordName$ !== $JSCompiler_alias_NULL$$ && ($i$$inline_477_response$$inline_196$$ = $tuna$rest$populateRecords$$($i$$inline_477_response$$inline_196$$, $self$$7$$.$__recordName$)), $self$$7$$.$dispatch$("result", $i$$inline_477_response$$inline_196$$)
      }else {
        if($data$$inline_195_errors$$inline_197_response$$ !== $JSCompiler_alias_VOID$$) {
          for(var $i$$inline_477_response$$inline_196$$ = 0, $l$$inline_478$$ = $data$$inline_195_errors$$inline_197_response$$.length, $error$$inline_479_name$$inline_515$$ = $JSCompiler_alias_NULL$$;$i$$inline_477_response$$inline_196$$ < $l$$inline_478$$;) {
            $error$$inline_479_name$$inline_515$$ = $data$$inline_195_errors$$inline_197_response$$[$i$$inline_477_response$$inline_196$$];
            if($error$$inline_479_name$$inline_515$$.param !== $JSCompiler_alias_VOID$$) {
              var $JSCompiler_StaticMethods___showInputError$self$$inline_480_JSCompiler_StaticMethods_showErrorMessage$self$$inline_520$$ = $self$$7$$, $message$$inline_481_message$$inline_521$$ = $error$$inline_479_name$$inline_515$$.message, $JSCompiler_StaticMethods___getFormInput$self$$inline_514_formInput$$inline_482$$;
              $JSCompiler_StaticMethods___getFormInput$self$$inline_514_formInput$$inline_482$$ = $JSCompiler_StaticMethods___showInputError$self$$inline_480_JSCompiler_StaticMethods_showErrorMessage$self$$inline_520$$;
              var $error$$inline_479_name$$inline_515$$ = $error$$inline_479_name$$inline_515$$.param, $result$$inline_516$$ = $JSCompiler_alias_NULL$$;
              if($JSCompiler_StaticMethods___getFormInput$self$$inline_514_formInput$$inline_482$$.$__inputTable$[$error$$inline_479_name$$inline_515$$] === $JSCompiler_alias_VOID$$) {
                var $input$$inline_518_inputWrapper$$inline_517$$ = $tuna$dom$selectOne$$(".j-" + $error$$inline_479_name$$inline_515$$ + "-input", $JSCompiler_StaticMethods___getFormInput$self$$inline_514_formInput$$inline_482$$.$_target$);
                $input$$inline_518_inputWrapper$$inline_517$$ !== $JSCompiler_alias_NULL$$ && ($input$$inline_518_inputWrapper$$inline_517$$ = new $tuna$ui$forms$FormInput$$($input$$inline_518_inputWrapper$$inline_517$$), $input$$inline_518_inputWrapper$$inline_517$$.init(), $JSCompiler_StaticMethods___getFormInput$self$$inline_514_formInput$$inline_482$$.$__inputTable$[$error$$inline_479_name$$inline_515$$] = $input$$inline_518_inputWrapper$$inline_517$$)
              }
              $JSCompiler_StaticMethods___getFormInput$self$$inline_514_formInput$$inline_482$$.$__inputTable$[$error$$inline_479_name$$inline_515$$] !== $JSCompiler_alias_VOID$$ && ($result$$inline_516$$ = $JSCompiler_StaticMethods___getFormInput$self$$inline_514_formInput$$inline_482$$.$__inputTable$[$error$$inline_479_name$$inline_515$$]);
              $JSCompiler_StaticMethods___getFormInput$self$$inline_514_formInput$$inline_482$$ = $result$$inline_516$$;
              $JSCompiler_StaticMethods___getFormInput$self$$inline_514_formInput$$inline_482$$ !== $JSCompiler_alias_NULL$$ ? ($JSCompiler_StaticMethods___showInputError$self$$inline_480_JSCompiler_StaticMethods_showErrorMessage$self$$inline_520$$ = $JSCompiler_StaticMethods___getFormInput$self$$inline_514_formInput$$inline_482$$, $tuna$dom$addClass$$($JSCompiler_StaticMethods___showInputError$self$$inline_480_JSCompiler_StaticMethods_showErrorMessage$self$$inline_520$$.$_target$, "error"), $JSCompiler_StaticMethods___showInputError$self$$inline_480_JSCompiler_StaticMethods_showErrorMessage$self$$inline_520$$.$__message$ !== 
              $JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods___showInputError$self$$inline_480_JSCompiler_StaticMethods_showErrorMessage$self$$inline_520$$.$__message$.innerHTML = $message$$inline_481_message$$inline_521$$)) : $JSCompiler_StaticMethods___showErrorMessage$$($JSCompiler_StaticMethods___showInputError$self$$inline_480_JSCompiler_StaticMethods_showErrorMessage$self$$inline_520$$, $message$$inline_481_message$$inline_521$$)
            }else {
              $JSCompiler_StaticMethods___showErrorMessage$$($self$$7$$, $error$$inline_479_name$$inline_515$$.message)
            }
            $i$$inline_477_response$$inline_196$$++
          }
...
function $JSCompiler_StaticMethods___prepareTo$$($JSCompiler_StaticMethods___prepareTo$self$$, $JSCompiler_StaticMethods_cleanup$self$$inline_484_type$$77$$, $event$$23$$) {
  if($JSCompiler_StaticMethods___prepareTo$self$$.$dispatch$($JSCompiler_StaticMethods_cleanup$self$$inline_484_type$$77$$)) {
    ...
    for(var $name$$inline_202$$ in $JSCompiler_StaticMethods___prepareTo$self$$.$__inputTable$) {
      $JSCompiler_StaticMethods_cleanup$self$$inline_484_type$$77$$ = $JSCompiler_StaticMethods___prepareTo$self$$.$__inputTable$[$name$$inline_202$$], $tuna$dom$removeClass$$($JSCompiler_StaticMethods_cleanup$self$$inline_484_type$$77$$.$_target$, "error"), $JSCompiler_StaticMethods_cleanup$self$$inline_484_type$$77$$.$__message$ !== $JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods_cleanup$self$$inline_484_type$$77$$.$__message$.innerHTML = $JSCompiler_StaticMethods_cleanup$self$$inline_484_type$$77$$.$__defaultMessage$)
    }
  }else {
...
$tuna$ui$transformers$TemplateTransformer$$.prototype.init = function $$tuna$ui$transformers$TemplateTransformer$$$$init$() {
  ...
  if($element$$inline_218_templateId$$ !== $JSCompiler_alias_NULL$$) {
    ...
    $JSCompiler_StaticMethods_addExtractor$$($conditionExtractor$$inline_487_settings$$11$$)), $tuna$tmpl$__settingsTable$$[$element$$inline_218_templateId$$] = $JSCompiler_StaticMethods_buildSettings$$($tuna$tmpl$__markupBuilder$$, $element$$inline_218_templateId$$));
    $conditionExtractor$$inline_487_settings$$11$$ = $tuna$tmpl$__settingsTable$$[$element$$inline_218_templateId$$];
    if($conditionExtractor$$inline_487_settings$$11$$ !== $JSCompiler_alias_NULL$$) {
      ...
      if($tuna$tmpl$__compiler$$ === $JSCompiler_alias_NULL$$) {
        ...
        var $conditionCompiler$$inline_490$$ = new $tuna$tmpl$compilers$ConditionCompiler$$;
        $conditionCompiler$$inline_490$$.$__actions$["class"] = new $tuna$tmpl$units$condition$ClassAction$$;
        $conditionCompiler$$inline_490$$.$__operators$.isset = new $tuna$tmpl$units$condition$IsSetOperator$$;
        $conditionCompiler$$inline_490$$.$__operators$.notset = new $tuna$tmpl$units$condition$NotSetOperator$$;
        $conditionCompiler$$inline_490$$.$__operators$.eq = new $tuna$tmpl$units$condition$EqualsOperator$$;
        $conditionCompiler$$inline_490$$.$__operators$.ne = new $tuna$tmpl$units$condition$NotEqualsOperator$$;
        $tuna$tmpl$__compiler$$.$__itemCompilers$.condition = $conditionCompiler$$inline_490$$
      }
      this.$__template$ = $tuna$tmpl$__compiler$$.compile($conditionExtractor$$inline_487_settings$$11$$, $element$$inline_218_templateId$$)
    }else {
...
$tuna$ui$selection$Navigation$$.prototype.init = function $$tuna$ui$selection$Navigation$$$$init$() {
  ...
  var $buttonSelector$$inline_248_buttons$$inline_250_currentIndex$$inline_256_itemsCollection$$inline_243$$ = new $tuna$ui$selection$items$NamedElementsCollection$$("data-name"), $i$$inline_251_menu$$inline_249_menuSelector$$inline_247_selectionView$$inline_244$$ = new $tuna$ui$selection$view$ClassSelectionView$$(this.$_target$), $className$$inline_493_l$$inline_252_selector$$inline_496$$ = $JSCompiler_StaticMethods_getStringOption$$(this, "selection-class");
  $i$$inline_251_menu$$inline_249_menuSelector$$inline_247_selectionView$$inline_244$$.$_selectionClass$ = $className$$inline_493_l$$inline_252_selector$$inline_496$$;
  $className$$inline_493_l$$inline_252_selector$$inline_496$$ = $JSCompiler_StaticMethods_getStringOption$$(this, "item-selector");
  $i$$inline_251_menu$$inline_249_menuSelector$$inline_247_selectionView$$inline_244$$.$_itemSelector$ = $className$$inline_493_l$$inline_252_selector$$inline_496$$;
  ...
  $JSCompiler_alias_NULL$$)) {
    for(var $buttonSelector$$inline_248_buttons$$inline_250_currentIndex$$inline_256_itemsCollection$$inline_243$$ = $tuna$dom$select$$($buttonSelector$$inline_248_buttons$$inline_250_currentIndex$$inline_256_itemsCollection$$inline_243$$, $i$$inline_251_menu$$inline_249_menuSelector$$inline_247_selectionView$$inline_244$$), $i$$inline_251_menu$$inline_249_menuSelector$$inline_247_selectionView$$inline_244$$ = 0, $className$$inline_493_l$$inline_252_selector$$inline_496$$ = $buttonSelector$$inline_248_buttons$$inline_250_currentIndex$$inline_256_itemsCollection$$inline_243$$.length, 
    $href$$inline_253_index$$inline_254$$ = $JSCompiler_alias_NULL$$, $button$$inline_255$$ = $href$$inline_253_index$$inline_254$$ = $JSCompiler_alias_NULL$$;$i$$inline_251_menu$$inline_249_menuSelector$$inline_247_selectionView$$inline_244$$ < $className$$inline_493_l$$inline_252_selector$$inline_496$$;) {
...
function $JSCompiler_StaticMethods___initControls$$($JSCompiler_StaticMethods___initControls$self$$) {
  ...
  $controls$$.addEventListener("navigate", function($event$$26$$, $button$$2$$) {
    ...
    if($index$$67$$ !== $JSCompiler_alias_NULL$$) {
      for(var $result$$inline_508$$ = {}, $attrs$$inline_509$$ = $button$$2$$.$_target$.attributes, $i$$inline_510$$ = 0, $l$$inline_511$$ = $attrs$$inline_509$$.length;$i$$inline_510$$ < $l$$inline_511$$;) {
        0 === $attrs$$inline_509$$[$i$$inline_510$$].name.indexOf("data-") && ($result$$inline_508$$[$attrs$$inline_509$$[$i$$inline_510$$].name.substr(5)] = $attrs$$inline_509$$[$i$$inline_510$$].value), $i$$inline_510$$++
      }
      delete $result$$inline_508$$.href;
      $JSCompiler_StaticMethods___initControls$self$$.navigate($index$$67$$, $result$$inline_508$$)
    }
  });
...
function $BakeryMainController$$() {
  $tuna$control$ViewController$$.call(this);
  this.$_modules$ = ["navigation", "template-transformer"]
}
$tuna$utils$extend$$($BakeryMainController$$, $tuna$control$ViewController$$);
$BakeryMainController$$.prototype.$_initActions$ = function $$BakeryMainController$$$$$_initActions$$() {
  ...
  var $id$$5$$ = $tuna$utils$config$$.get("bakery_id");
  $id$$5$$ !== $JSCompiler_alias_NULL$$ && $tuna$rest$call$$("users.getBakeries", {id:$id$$5$$}, function($bakery$$8$$) {
    $model$currentBakery$$.set($bakery$$8$$)
  }, "bakery");
  $model$decorations$$.load()
};
$tuna$control$__mainController$$ = new $BakeryMainController$$;
})();

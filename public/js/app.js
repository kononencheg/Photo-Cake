...
SWF.prototype.init = function() {
  ...
  swfobject.embedSWF(this.getOption("src"), this._target.id, this.getOption("width"), this.getOption("height"), "10.0.0", null, this.getOption("flashvars"), {"wmode":this.getOption("wmode"), "allowfullscreen":this.getOption("allow-fullscreen"), "allowscriptaccess":this.getOption("allow-script-access"), "menu":this.getOption("menu")})
};
...
(function($, undefined) {
  ...
  $.extend(Datepicker.prototype, {markerClassName:"hasDatepicker", maxRows:4, log:function() {
    ...
    var c = this._get(a, "isRTL"), d = this._get(a, "showButtonPanel"), e = this._get(a, "hideIfNoPrevNext"), f = this._get(a, "navigationAsDateFormat"), g = this._getNumberOfMonths(a), h = this._get(a, "showCurrentAtPos"), i = this._get(a, "stepMonths"), j = g[0] != 1 || g[1] != 1, k = this._daylightSavingAdjust(a.currentDay ? new Date(a.currentYear, a.currentMonth, a.currentDay) : new Date(9999, 9, 9)), l = this._getMinMaxDate(a, "min"), m = this._getMinMaxDate(a, "max"), n = a.drawMonth - h, o = 
    a.drawYear;
    n < 0 && (n += 12, o--);
    if(m) {
      ...
      for(var N = 0;N < g[1];N++) {
        ...
        for(var Z = 0;Z < X;Z++) {
          ...
          for(var S = 0;S < 7;S++) {
            ...
            _ += '<td class="' + ((S + y + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (bb ? " ui-datepicker-other-month" : "") + (Y.getTime() == O.getTime() && n == a.selectedMonth && a._keyEvent || J.getTime() == Y.getTime() && J.getTime() == O.getTime() ? " " + this._dayOverClass : "") + (bc ? " " + this._unselectableClass + " ui-state-disabled" : "") + (bb && !G ? "" : " " + ba[1] + (Y.getTime() == k.getTime() ? " " + this._currentClass : "") + (Y.getTime() == b.getTime() ? " ui-datepicker-today" : 
            "")) + '"' + ((!bb || G) && ba[2] ? ' title="' + ba[2] + '"' : "") + (bc ? "" : ' onclick="DP_jQuery_' + dpuuid + ".datepicker._selectDay('#" + a.id + "'," + Y.getMonth() + "," + Y.getFullYear() + ', this);return false;"') + ">" + (bb && !G ? "&#xa0;" : bc ? '<span class="ui-state-default">' + Y.getDate() + "</span>" : '<a class="ui-state-default' + (Y.getTime() == b.getTime() ? " ui-state-highlight" : "") + (Y.getTime() == k.getTime() ? " ui-state-active" : "") + (bb ? " ui-priority-secondary" : 
...
jQuery(function($) {
  $.datepicker.regional["ru"] = {closeText:"\u0417\u0430\u043a\u0440\u044b\u0442\u044c", prevText:"&#x3c;\u041f\u0440\u0435\u0434", nextText:"\u0421\u043b\u0435\u0434&#x3e;", currentText:"\u0421\u0435\u0433\u043e\u0434\u043d\u044f", monthNames:["\u042f\u043d\u0432\u0430\u0440\u044c", "\u0424\u0435\u0432\u0440\u0430\u043b\u044c", "\u041c\u0430\u0440\u0442", "\u0410\u043f\u0440\u0435\u043b\u044c", "\u041c\u0430\u0439", "\u0418\u044e\u043d\u044c", "\u0418\u044e\u043b\u044c", "\u0410\u0432\u0433\u0443\u0441\u0442", 
  "\u0421\u0435\u043d\u0442\u044f\u0431\u0440\u044c", "\u041e\u043a\u0442\u044f\u0431\u0440\u044c", "\u041d\u043e\u044f\u0431\u0440\u044c", "\u0414\u0435\u043a\u0430\u0431\u0440\u044c"], monthNamesShort:["\u042f\u043d\u0432", "\u0424\u0435\u0432", "\u041c\u0430\u0440", "\u0410\u043f\u0440", "\u041c\u0430\u0439", "\u0418\u044e\u043d", "\u0418\u044e\u043b", "\u0410\u0432\u0433", "\u0421\u0435\u043d", "\u041e\u043a\u0442", "\u041d\u043e\u044f", "\u0414\u0435\u043a"], dayNames:["\u0432\u043e\u0441\u043a\u0440\u0435\u0441\u0435\u043d\u044c\u0435", 
  "\u043f\u043e\u043d\u0435\u0434\u0435\u043b\u044c\u043d\u0438\u043a", "\u0432\u0442\u043e\u0440\u043d\u0438\u043a", "\u0441\u0440\u0435\u0434\u0430", "\u0447\u0435\u0442\u0432\u0435\u0440\u0433", "\u043f\u044f\u0442\u043d\u0438\u0446\u0430", "\u0441\u0443\u0431\u0431\u043e\u0442\u0430"], dayNamesShort:["\u0432\u0441\u043a", "\u043f\u043d\u0434", "\u0432\u0442\u0440", "\u0441\u0440\u0434", "\u0447\u0442\u0432", "\u043f\u0442\u043d", "\u0441\u0431\u0442"], dayNamesMin:["\u0412\u0441", "\u041f\u043d", 
  ...
  DataImage.prototype.setData = function(data, type) {
    ...
    if(!tuna.utils.IS_IE) {
      ...
      tuna.dom.addOneEventListener(frame, "load", function() {
        var image = tuna.dom.selectOne("img", frame.contentWindow.document.body);
        if(image !== null) {
...
(function() {
  ...
  CakeImagePopup.prototype.initInstance = function(target) {
    ...
    function syncWidth() {
      $(".image-container", popupTarget).width($(photoImage).width() + $(beforeImage).width() + $(afterImage).width() + 15)
    }
    photoImage.onload = beforeImage.onload = afterImage.onload = syncWidth;
    tuna.dom.addEventListener(target, "click", function(event) {
      tuna.dom.preventDefault(event);
...
(function() {
  ...
  Datepicker.prototype.initInstance = function(target) {
    var minTime = (new Date).getTime() + 3 * 24 * 60 * 60 * 1E3;
    $(target).keydown(function(event) {
      event.preventDefault()
    }).datepicker({"minDate":new Date(minTime)});
    return target
  };
...
(function() {
  ...
  DataImageCopy.prototype.initInstance = function(target) {
    ...
    if(imageSelector !== null) {
      ...
      var targetDataImage = ui.DataImage.create(tuna.dom.selectOne(imageSelector));
...
(function() {
  ...
  FriendsPopup.prototype.initInstance = function(target) {
    ...
    tuna.dom.addChildEventListener(popupElement, ".j-send-button", "click", function() {
  ...
  FriendsPopup.prototype.postImage = function(userId) {
    ...
    tuna.rest.call("social.wall.post", {"image":currentCake.imageBase64, "user_id":userId}, function() {
...
(function() {
  ...
  Orders.prototype.__updateOrderPrice = function() {
    ...
    if(this.__order.recipe !== null) {
      payment.recipePrice = this.__getRecipePrice(this.__order.cake, this.__order.recipe)
    }
    if(this.__order.bakery !== null) {
      payment.deliveryPrice = this.__order.bakery.deliveryPrice
    }
    payment.totalPrice = payment.decoPrice + payment.recipePrice + payment.deliveryPrice
  };
...
(function() {
  ...
  DesignerController.prototype.confirmShapeChange = function(shape) {
    var self = this;
    tuna.ui.popups.confirm("\u041f\u0440\u0438 \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u0438 \u0444\u043e\u0440\u043c\u044b \u0442\u043e\u0440\u0442\u0430, \u0432\u0441\u0435 \u043e\u0444\u043e\u0440\u043c\u043b\u0435\u043d\u0438\u0435 \u0431\u0443\u0434\u0435\u0442 \u0443\u0442\u0435\u0440\u044f\u043d\u043e!", function(result) {
      if(result) {
  ...
  DesignerController.prototype.close = function() {
    ...
    var cake = model.cakes.createCake(data.shift(), data.shift(), data.shift());
  ...
  window.openMessageBox = function(message) {
    tuna.ui.popups.alert(message)
  };
...
(function() {
  ...
  ShareController.prototype._initActions = function() {
    ...
    if(postLink !== null) {
      tuna.dom.addEventListener(postLink, "click", function(event) {
        tuna.dom.preventDefault(event);
...
(function() {
  ...
  RecipeController.prototype.__initCityPopup = function() {
    var self = this;
    this.__cityAutocomplete = this._container.getOneModuleInstance("autocomplete");
    ...
    this.__cityPopup = tuna.ui.popups.create(tuna.dom.selectOne("#city_selection_popup"));
    var bakery = null;
  ...
  RecipeController.prototype.__initDescriptionPopup = function() {
    var descriptionPopup = tuna.ui.popups.create(tuna.dom.selectOne("#recipe_description_popup"));
    var self = this;
  ...
  RecipeController.prototype.__initRecipeSelection = function() {
    ...
    tuna.dom.addChildEventListener(target, ".j-recipe-image", "click", function(event) {
      var index = this.getAttribute("data-index");
      self.__popupRecipe = model.recipes.getRecipeAt(index);
      self.__popupIndex = index;
      self.__updateView()
    });
    tuna.dom.addChildEventListener(target, "input.j-recipe-radio", "click", function(event) {
  ...
  RecipeController.prototype.__loadRecipes = function() {
    ...
    tuna.rest.call("recipes.getList", {"bakery_id":bakery.id}, function(result) {
...
(function() {
  ...
  OrderController.prototype._initActions = function() {
    ...
    this.__form.addEventListener("submit", function(event) {
      if(!isConfirmed) {
        event.preventDefault();
        tuna.ui.popups.confirm("\u0412\u044b \u0443\u0432\u0435\u0440\u0435\u043d\u044b \u0447\u0442\u043e \u043f\u0440\u0430\u0432\u0438\u043b\u044c\u043d\u043e \u0437\u0430\u043f\u043e\u043b\u043d\u0438\u043b\u0438 \u0432\u0441\u0435 \u043f\u043e\u043b\u044f?", function(result) {
          isConfirmed = result;
          if(isConfirmed) {
            self.__form.submit()
          }
    ...
    this.__cakeImage = this._container.getOneModuleInstance("data-image-copy")
  };

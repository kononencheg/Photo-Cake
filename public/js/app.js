...
function $tuna$dom$addOneEventListener$$($element$$12$$, $type$$50$$, $handler$$5$$) {
  ...
  $handler$$5$$[$listenerId$$2$$] = function $$handler$$5$$$$listenerId$$2$$$($event$$5_listenerId$$inline_23$$) {
    ...
    if($handler$$5$$[$event$$5_listenerId$$inline_23$$] !== $JSCompiler_alias_VOID$$) {
      var $handler$$inline_463$$ = $handler$$5$$[$event$$5_listenerId$$inline_23$$];
      if($element$$12$$.removeEventListener !== $JSCompiler_alias_VOID$$) {
        $element$$12$$.removeEventListener($type$$50$$, $handler$$inline_463$$, $JSCompiler_alias_FALSE$$)
      }else {
        if($element$$12$$.detachEvent !== $JSCompiler_alias_VOID$$) {
          if($element$$12$$["on" + $type$$50$$] === $JSCompiler_alias_VOID$$) {
            var $handlers$$inline_464_listenerId$$inline_466$$ = $element$$12$$["__" + $type$$50$$];
            if($handlers$$inline_464_listenerId$$inline_466$$ !== $JSCompiler_alias_VOID$$) {
              for(var $i$$inline_465$$ = $handlers$$inline_464_listenerId$$inline_466$$.length - 1;0 <= $i$$inline_465$$;) {
                $handlers$$inline_464_listenerId$$inline_466$$[$i$$inline_465$$] === $handler$$inline_463$$ && $handlers$$inline_464_listenerId$$inline_466$$.splice($i$$inline_465$$, 1), $i$$inline_465$$--
              }
            }
          }else {
            $handlers$$inline_464_listenerId$$inline_466$$ = $element$$12$$.$__ieTargetId$ + "_" + $type$$50$$, $handler$$inline_463$$[$handlers$$inline_464_listenerId$$inline_466$$] !== $JSCompiler_alias_VOID$$ && ($element$$12$$.detachEvent("on" + $type$$50$$, $handler$$inline_463$$[$handlers$$inline_464_listenerId$$inline_466$$]), delete $handler$$inline_463$$[$handlers$$inline_464_listenerId$$inline_466$$])
          }
        }
      }
...
$tuna$tmpl$units$Attribute$$.prototype.$__dispatchAttribute$ = function $$tuna$tmpl$units$Attribute$$$$$__dispatchAttribute$$() {
  for(var $i$$23$$ = this.$_nodes$.length - 1;0 <= $i$$23$$;) {
    var $element$$inline_468_element$$inline_77$$ = this.$_nodes$[$i$$23$$], $type$$inline_78$$ = this.$__attributeName$, $event$$inline_469_event$$inline_79$$ = $JSCompiler_alias_NULL$$;
    if(document.createEventObject !== $JSCompiler_alias_VOID$$) {
      var $event$$inline_469_event$$inline_79$$ = document.createEventObject(), $eventName$$inline_80$$ = "on" + $type$$inline_78$$;
      $element$$inline_468_element$$inline_77$$[$eventName$$inline_80$$] === $JSCompiler_alias_VOID$$ ? ($event$$inline_469_event$$inline_79$$.$__type$ = $type$$inline_78$$, $element$$inline_468_element$$inline_77$$.fireEvent("onhelp", $event$$inline_469_event$$inline_79$$)) : $element$$inline_468_element$$inline_77$$.fireEvent($eventName$$inline_80$$, $event$$inline_469_event$$inline_79$$)
    }else {
      $event$$inline_469_event$$inline_79$$ = document.createEvent("UIEvents"), $event$$inline_469_event$$inline_79$$.initUIEvent($type$$inline_78$$, $JSCompiler_alias_TRUE$$, $JSCompiler_alias_TRUE$$, window, 1), $element$$inline_468_element$$inline_77$$.dispatchEvent($event$$inline_469_event$$inline_79$$)
    }
    $i$$23$$--
  }
};
...
$tuna$ui$Module$$.prototype.init = function $$tuna$ui$Module$$$$init$($context$$2$$, $container$$1$$) {
  ...
  for(var $i$$29$$ = 0, $l$$18$$ = $targets_targets$$inline_178$$.length, $instance_target$$inline_181$$ = $JSCompiler_alias_NULL$$;$i$$29$$ < $l$$18$$;) {
    for(var $instance_target$$inline_181$$ = $targets_targets$$inline_178$$[$i$$29$$], $context$$inline_182$$ = $context$$2$$, $JSCompiler_temp$$456_JSCompiler_temp$$457_className$$inline_474_result$$inline_183$$ = $JSCompiler_alias_TRUE$$, $isolators$$inline_184$$ = $tuna$ui$__isolators$$, $i$$inline_185$$ = 0, $l$$inline_186$$ = $isolators$$inline_184$$.length;$i$$inline_185$$ < $l$$inline_186$$;) {
      if($instance_target$$inline_181$$ !== $context$$inline_182$$) {
        if($JSCompiler_temp$$456_JSCompiler_temp$$457_className$$inline_474_result$$inline_183$$ && ($JSCompiler_temp$$456_JSCompiler_temp$$457_className$$inline_474_result$$inline_183$$ = !$tuna$dom$hasClass$$($instance_target$$inline_181$$, $isolators$$inline_184$$[$i$$inline_185$$]))) {
          for(var $JSCompiler_temp$$456_JSCompiler_temp$$457_className$$inline_474_result$$inline_183$$ = $isolators$$inline_184$$[$i$$inline_185$$], $opt_context$$inline_475$$ = $context$$inline_182$$, $parent$$inline_476$$ = $instance_target$$inline_181$$.parentNode;$parent$$inline_476$$ !== $JSCompiler_alias_NULL$$ && $parent$$inline_476$$ !== $opt_context$$inline_475$$ && !$tuna$dom$hasClass$$($parent$$inline_476$$, $JSCompiler_temp$$456_JSCompiler_temp$$457_className$$inline_474_result$$inline_183$$);) {
            $parent$$inline_476$$ = $parent$$inline_476$$.parentNode
          }
          $JSCompiler_temp$$456_JSCompiler_temp$$457_className$$inline_474_result$$inline_183$$ = ($parent$$inline_476$$ === $opt_context$$inline_475$$ ? $JSCompiler_alias_NULL$$ : $parent$$inline_476$$) === $JSCompiler_alias_NULL$$
        }
        if(!$JSCompiler_temp$$456_JSCompiler_temp$$457_className$$inline_474_result$$inline_183$$) {
          break
        }
      }
      $i$$inline_185$$++
    }
    $JSCompiler_temp$$456_JSCompiler_temp$$457_className$$inline_474_result$$inline_183$$ && ($instance_target$$inline_181$$ = this.$initInstance$($targets_targets$$inline_178$$[$i$$29$$], $container$$1$$), $instance_target$$inline_181$$ !== $JSCompiler_alias_NULL$$ && ($instances$$.push($instance_target$$inline_181$$), $JSCompiler_StaticMethods_getBooleanOption$$($instance_target$$inline_181$$, "not-init") || $instance_target$$inline_181$$.init()));
    $i$$29$$++
  }
  return $instances$$
};
...
$JSCompiler_prototypeAlias$$.init = function $$JSCompiler_prototypeAlias$$$init$() {
  ...
  $tuna$dom$addEventListener$$(this.$_target$, "submit", function($event$$21$$) {
    $self$$7$$.isEnabled() ? ($callbackInput$$.value = "form_callback" + (Math.random() + "").substr(2), window[$callbackInput$$.value] = function $window$$callbackInput$$$value$($data$$inline_195_errors$$inline_197_response$$) {
      var $data$$inline_195_errors$$inline_197_response$$ = JSON.parse(JSON.stringify($data$$inline_195_errors$$inline_197_response$$)), $i$$inline_480_response$$inline_196$$ = $data$$inline_195_errors$$inline_197_response$$.response, $data$$inline_195_errors$$inline_197_response$$ = $data$$inline_195_errors$$inline_197_response$$.errors;
      if($i$$inline_480_response$$inline_196$$ !== $JSCompiler_alias_VOID$$) {
        $self$$7$$.$__recordName$ !== $JSCompiler_alias_NULL$$ && ($i$$inline_480_response$$inline_196$$ = $tuna$rest$populateRecords$$($i$$inline_480_response$$inline_196$$, $self$$7$$.$__recordName$)), $self$$7$$.$dispatch$("result", $i$$inline_480_response$$inline_196$$)
      }else {
        if($data$$inline_195_errors$$inline_197_response$$ !== $JSCompiler_alias_VOID$$) {
          for(var $i$$inline_480_response$$inline_196$$ = 0, $l$$inline_481$$ = $data$$inline_195_errors$$inline_197_response$$.length, $error$$inline_482_name$$inline_518$$ = $JSCompiler_alias_NULL$$;$i$$inline_480_response$$inline_196$$ < $l$$inline_481$$;) {
            $error$$inline_482_name$$inline_518$$ = $data$$inline_195_errors$$inline_197_response$$[$i$$inline_480_response$$inline_196$$];
            if($error$$inline_482_name$$inline_518$$.param !== $JSCompiler_alias_VOID$$) {
              var $JSCompiler_StaticMethods___showInputError$self$$inline_483_JSCompiler_StaticMethods_showErrorMessage$self$$inline_523$$ = $self$$7$$, $message$$inline_484_message$$inline_524$$ = $error$$inline_482_name$$inline_518$$.message, $JSCompiler_StaticMethods___getFormInput$self$$inline_517_formInput$$inline_485$$;
              $JSCompiler_StaticMethods___getFormInput$self$$inline_517_formInput$$inline_485$$ = $JSCompiler_StaticMethods___showInputError$self$$inline_483_JSCompiler_StaticMethods_showErrorMessage$self$$inline_523$$;
              var $error$$inline_482_name$$inline_518$$ = $error$$inline_482_name$$inline_518$$.param, $result$$inline_519$$ = $JSCompiler_alias_NULL$$;
              if($JSCompiler_StaticMethods___getFormInput$self$$inline_517_formInput$$inline_485$$.$__inputTable$[$error$$inline_482_name$$inline_518$$] === $JSCompiler_alias_VOID$$) {
                var $input$$inline_521_inputWrapper$$inline_520$$ = $tuna$dom$selectOne$$(".j-" + $error$$inline_482_name$$inline_518$$ + "-input", $JSCompiler_StaticMethods___getFormInput$self$$inline_517_formInput$$inline_485$$.$_target$);
                $input$$inline_521_inputWrapper$$inline_520$$ !== $JSCompiler_alias_NULL$$ && ($input$$inline_521_inputWrapper$$inline_520$$ = new $tuna$ui$forms$FormInput$$($input$$inline_521_inputWrapper$$inline_520$$), $input$$inline_521_inputWrapper$$inline_520$$.init(), $JSCompiler_StaticMethods___getFormInput$self$$inline_517_formInput$$inline_485$$.$__inputTable$[$error$$inline_482_name$$inline_518$$] = $input$$inline_521_inputWrapper$$inline_520$$)
              }
              $JSCompiler_StaticMethods___getFormInput$self$$inline_517_formInput$$inline_485$$.$__inputTable$[$error$$inline_482_name$$inline_518$$] !== $JSCompiler_alias_VOID$$ && ($result$$inline_519$$ = $JSCompiler_StaticMethods___getFormInput$self$$inline_517_formInput$$inline_485$$.$__inputTable$[$error$$inline_482_name$$inline_518$$]);
              $JSCompiler_StaticMethods___getFormInput$self$$inline_517_formInput$$inline_485$$ = $result$$inline_519$$;
              $JSCompiler_StaticMethods___getFormInput$self$$inline_517_formInput$$inline_485$$ !== $JSCompiler_alias_NULL$$ ? ($JSCompiler_StaticMethods___showInputError$self$$inline_483_JSCompiler_StaticMethods_showErrorMessage$self$$inline_523$$ = $JSCompiler_StaticMethods___getFormInput$self$$inline_517_formInput$$inline_485$$, $tuna$dom$addClass$$($JSCompiler_StaticMethods___showInputError$self$$inline_483_JSCompiler_StaticMethods_showErrorMessage$self$$inline_523$$.$_target$, "error"), $JSCompiler_StaticMethods___showInputError$self$$inline_483_JSCompiler_StaticMethods_showErrorMessage$self$$inline_523$$.$__message$ !== 
              $JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods___showInputError$self$$inline_483_JSCompiler_StaticMethods_showErrorMessage$self$$inline_523$$.$__message$.innerHTML = $message$$inline_484_message$$inline_524$$)) : $JSCompiler_StaticMethods___showErrorMessage$$($JSCompiler_StaticMethods___showInputError$self$$inline_483_JSCompiler_StaticMethods_showErrorMessage$self$$inline_523$$, $message$$inline_484_message$$inline_524$$)
            }else {
              $JSCompiler_StaticMethods___showErrorMessage$$($self$$7$$, $error$$inline_482_name$$inline_518$$.message)
            }
            $i$$inline_480_response$$inline_196$$++
          }
...
function $JSCompiler_StaticMethods___prepareTo$$($JSCompiler_StaticMethods___prepareTo$self$$, $JSCompiler_StaticMethods_cleanup$self$$inline_487_type$$77$$, $event$$23$$) {
  if($JSCompiler_StaticMethods___prepareTo$self$$.$dispatch$($JSCompiler_StaticMethods_cleanup$self$$inline_487_type$$77$$)) {
    ...
    for(var $name$$inline_202$$ in $JSCompiler_StaticMethods___prepareTo$self$$.$__inputTable$) {
      $JSCompiler_StaticMethods_cleanup$self$$inline_487_type$$77$$ = $JSCompiler_StaticMethods___prepareTo$self$$.$__inputTable$[$name$$inline_202$$], $tuna$dom$removeClass$$($JSCompiler_StaticMethods_cleanup$self$$inline_487_type$$77$$.$_target$, "error"), $JSCompiler_StaticMethods_cleanup$self$$inline_487_type$$77$$.$__message$ !== $JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods_cleanup$self$$inline_487_type$$77$$.$__message$.innerHTML = $JSCompiler_StaticMethods_cleanup$self$$inline_487_type$$77$$.$__defaultMessage$)
    }
  }else {
...
$tuna$ui$transformers$TemplateTransformer$$.prototype.init = function $$tuna$ui$transformers$TemplateTransformer$$$$init$() {
  ...
  if($element$$inline_218_templateId$$ !== $JSCompiler_alias_NULL$$) {
    var $conditionExtractor$$inline_490_settings$$11$$;
    ...
    $JSCompiler_StaticMethods_addExtractor$$(new $tuna$tmpl$markup$CheckboxExtractor$$), $conditionExtractor$$inline_490_settings$$11$$ = new $tuna$tmpl$markup$ConditionExtractor$$, $conditionExtractor$$inline_490_settings$$11$$.$__actions$.push("class"), $conditionExtractor$$inline_490_settings$$11$$.$__operators$.push("isset"), $conditionExtractor$$inline_490_settings$$11$$.$__operators$.push("notset"), $conditionExtractor$$inline_490_settings$$11$$.$__operators$.push("eq"), $conditionExtractor$$inline_490_settings$$11$$.$__operators$.push("ne"), 
    $JSCompiler_StaticMethods_addExtractor$$($conditionExtractor$$inline_490_settings$$11$$)), $tuna$tmpl$__settingsTable$$[$element$$inline_218_templateId$$] = $JSCompiler_StaticMethods_buildSettings$$($tuna$tmpl$__markupBuilder$$, $element$$inline_218_templateId$$));
    $conditionExtractor$$inline_490_settings$$11$$ = $tuna$tmpl$__settingsTable$$[$element$$inline_218_templateId$$];
    if($conditionExtractor$$inline_490_settings$$11$$ !== $JSCompiler_alias_NULL$$) {
      ...
      if($tuna$tmpl$__compiler$$ === $JSCompiler_alias_NULL$$) {
        ...
        var $conditionCompiler$$inline_493$$ = new $tuna$tmpl$compilers$ConditionCompiler$$;
        $conditionCompiler$$inline_493$$.$__actions$["class"] = new $tuna$tmpl$units$condition$ClassAction$$;
        $conditionCompiler$$inline_493$$.$__operators$.isset = new $tuna$tmpl$units$condition$IsSetOperator$$;
        $conditionCompiler$$inline_493$$.$__operators$.notset = new $tuna$tmpl$units$condition$NotSetOperator$$;
        $conditionCompiler$$inline_493$$.$__operators$.eq = new $tuna$tmpl$units$condition$EqualsOperator$$;
        $conditionCompiler$$inline_493$$.$__operators$.ne = new $tuna$tmpl$units$condition$NotEqualsOperator$$;
        $tuna$tmpl$__compiler$$.$__itemCompilers$.condition = $conditionCompiler$$inline_493$$
      }
      this.$__template$ = $tuna$tmpl$__compiler$$.compile($conditionExtractor$$inline_490_settings$$11$$, $element$$inline_218_templateId$$)
    }else {
...
$tuna$ui$selection$Navigation$$.prototype.init = function $$tuna$ui$selection$Navigation$$$$init$() {
  ...
  var $buttonSelector$$inline_248_buttons$$inline_250_currentIndex$$inline_256_itemsCollection$$inline_243$$ = new $tuna$ui$selection$items$NamedElementsCollection$$("data-name"), $i$$inline_251_menu$$inline_249_menuSelector$$inline_247_selectionView$$inline_244$$ = new $tuna$ui$selection$view$ClassSelectionView$$(this.$_target$), $className$$inline_496_l$$inline_252_selector$$inline_499$$ = $JSCompiler_StaticMethods_getStringOption$$(this, "selection-class");
  $i$$inline_251_menu$$inline_249_menuSelector$$inline_247_selectionView$$inline_244$$.$_selectionClass$ = $className$$inline_496_l$$inline_252_selector$$inline_499$$;
  $className$$inline_496_l$$inline_252_selector$$inline_499$$ = $JSCompiler_StaticMethods_getStringOption$$(this, "item-selector");
  $i$$inline_251_menu$$inline_249_menuSelector$$inline_247_selectionView$$inline_244$$.$_itemSelector$ = $className$$inline_496_l$$inline_252_selector$$inline_499$$;
  ...
  $JSCompiler_alias_NULL$$)) {
    for(var $buttonSelector$$inline_248_buttons$$inline_250_currentIndex$$inline_256_itemsCollection$$inline_243$$ = $tuna$dom$select$$($buttonSelector$$inline_248_buttons$$inline_250_currentIndex$$inline_256_itemsCollection$$inline_243$$, $i$$inline_251_menu$$inline_249_menuSelector$$inline_247_selectionView$$inline_244$$), $i$$inline_251_menu$$inline_249_menuSelector$$inline_247_selectionView$$inline_244$$ = 0, $className$$inline_496_l$$inline_252_selector$$inline_499$$ = $buttonSelector$$inline_248_buttons$$inline_250_currentIndex$$inline_256_itemsCollection$$inline_243$$.length, 
    $href$$inline_253_index$$inline_254$$ = $JSCompiler_alias_NULL$$, $button$$inline_255$$ = $href$$inline_253_index$$inline_254$$ = $JSCompiler_alias_NULL$$;$i$$inline_251_menu$$inline_249_menuSelector$$inline_247_selectionView$$inline_244$$ < $className$$inline_496_l$$inline_252_selector$$inline_499$$;) {
...
function $rest$CommonMethod$$($opt_name$$4$$) {
  ...
  this.$__completeHandler$ = $tuna$utils$bind$$(function($event$$32$$, $data$$38$$) {
    var $result$$inline_389$$ = $JSCompiler_alias_NULL$$;
    try {
      $result$$inline_389$$ = JSON.parse($data$$38$$)
    }catch($error$$inline_390$$) {
      $self$$14$$.$dispatch$("error", $data$$38$$)
    }
    $result$$inline_389$$ !== $JSCompiler_alias_NULL$$ ? $result$$inline_389$$.response !== $JSCompiler_alias_VOID$$ ? $self$$14$$.$dispatch$("result", $result$$inline_389$$.response) : $self$$14$$.$dispatch$("error", $result$$inline_389$$.errors || $result$$inline_389$$) : $self$$14$$.$dispatch$("error", $data$$38$$)
  }, this);
...
var $JSCompiler_StaticMethods_setDefaultMethod$self$$inline_397$$ = $tuna$rest$methodFactory$$, $method$$inline_398$$ = new $rest$CommonMethod$$;
$JSCompiler_StaticMethods_setDefaultMethod$self$$inline_397$$.$__defaultMethod$ = $method$$inline_398$$;
...
var $record$$inline_402$$ = new $Dimension$$;
$tuna$model$recordFactory$$.$__prototypes$.dimension = $record$$inline_402$$;
...
var $record$$inline_406$$ = new $City$$;
$tuna$model$recordFactory$$.$__prototypes$.city = $record$$inline_406$$;
...
var $record$$inline_410$$ = new $Bakery$$;
$tuna$model$recordFactory$$.$__prototypes$.bakery = $record$$inline_410$$;
...
var $record$$inline_414$$ = new $Cake$$;
$tuna$model$recordFactory$$.$__prototypes$.cake = $record$$inline_414$$;
...
$model$records$Order$$.prototype.$serialize$ = function $$model$records$Order$$$$$serialize$$() {
  var $decorationPrice_price$$inline_418$$;
  $decorationPrice_price$$inline_418$$ = 0;
  if(this.$cake$ !== $JSCompiler_alias_NULL$$) {
    var $deco$$inline_419_recipePrice$$ = this.$cake$.$__markupJson$.content.deco !== $JSCompiler_alias_VOID$$ ? this.$cake$.$__markupJson$.content.deco : $JSCompiler_alias_NULL$$;
    if($deco$$inline_419_recipePrice$$ !== $JSCompiler_alias_NULL$$) {
      for(var $deliveryPrice_i$$inline_420$$ = 0, $l$$inline_421$$ = $deco$$inline_419_recipePrice$$.length;$deliveryPrice_i$$inline_420$$ < $l$$inline_421$$;) {
        $decorationPrice_price$$inline_418$$ += this.$bakery$.$decorationPrices$[$deco$$inline_419_recipePrice$$[$deliveryPrice_i$$inline_420$$].name], $deliveryPrice_i$$inline_420$$++
      }
    }
  }
  $deco$$inline_419_recipePrice$$ = this.$recipe$ !== $JSCompiler_alias_NULL$$ && this.$cake$ !== $JSCompiler_alias_NULL$$ ? $JSCompiler_StaticMethods_getWeightPrice$$(this.$recipe$, this.$cake$.$dimension$.$weight$) : 0;
  $deliveryPrice_i$$inline_420$$ = !this.$isPickup$ && this.$bakery$ !== $JSCompiler_alias_NULL$$ ? this.$bakery$.$deliveryPrice$ : 0;
  return{cake:$tuna$model$serialize$$(this.$cake$), recipe:$tuna$model$serialize$$(this.$recipe$), bakery:$tuna$model$serialize$$(this.$bakery$), decorationPrice:$decorationPrice_price$$inline_418$$, recipePrice:$deco$$inline_419_recipePrice$$, deliveryPrice:$deliveryPrice_i$$inline_420$$, totalPrice:$decorationPrice_price$$inline_418$$ + $deco$$inline_419_recipePrice$$ + $deliveryPrice_i$$inline_420$$}
};
var $record$$inline_425$$ = new $model$records$Order$$;
$tuna$model$recordFactory$$.$__prototypes$.order = $record$$inline_425$$;
...
var $model$records$Recipe$$ = $Recipe$$, $record$$inline_429$$ = new $model$records$Recipe$$;
$tuna$model$recordFactory$$.$__prototypes$.recipe = $record$$inline_429$$;
function $User$$() {
...
var $record$$inline_433$$ = new $Decoration$$;
$tuna$model$recordFactory$$.$__prototypes$.decoration = $record$$inline_433$$;
...
$JSCompiler_prototypeAlias$$.$onFlashReady$ = function $$JSCompiler_prototypeAlias$$$$onFlashReady$$() {
  var $JSCompiler_StaticMethods_getMovie$self$$inline_439$$ = this.$__designerSWF$;
  $JSCompiler_StaticMethods_getMovie$self$$inline_439$$.$__movieId$ !== $JSCompiler_alias_NULL$$ && $JSCompiler_StaticMethods_getMovie$self$$inline_439$$.$__movie$ === $JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods_getMovie$self$$inline_439$$.$__movie$ = swfobject.getObjectById($JSCompiler_StaticMethods_getMovie$self$$inline_439$$.$__movieId$));
  this.$__movie$ = $JSCompiler_StaticMethods_getMovie$self$$inline_439$$.$__movie$;
...
$JSCompiler_prototypeAlias$$.$_initActions$ = function $$JSCompiler_prototypeAlias$$$$_initActions$$() {
  ...
  $JSCompiler_StaticMethods_setValue$$(this.$__orderForm$, "client_network", 0);
...
var $controller$$inline_445$$ = new $OrderController$$;
$tuna$control$__controllerTable$$.order_step = $controller$$inline_445$$;
...
$tuna$control$__controllerTable$$.share_step = new $ShareController$$;

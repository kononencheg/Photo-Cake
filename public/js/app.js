...
function $tuna$dom$addOneEventListener$$($element$$11$$, $type$$50$$, $handler$$5$$) {
  ...
  $handler$$5$$[$listenerId$$2$$] = function $$handler$$5$$$$listenerId$$2$$$($event$$5_listenerId$$inline_22$$) {
    ...
    if($handler$$5$$[$event$$5_listenerId$$inline_22$$] !== $JSCompiler_alias_VOID$$) {
      var $handler$$inline_439$$ = $handler$$5$$[$event$$5_listenerId$$inline_22$$];
      if($element$$11$$.removeEventListener !== $JSCompiler_alias_VOID$$) {
        $element$$11$$.removeEventListener($type$$50$$, $handler$$inline_439$$, $JSCompiler_alias_FALSE$$)
      }else {
        if($element$$11$$.detachEvent !== $JSCompiler_alias_VOID$$) {
          if($element$$11$$["on" + $type$$50$$] === $JSCompiler_alias_VOID$$) {
            var $handlers$$inline_440_listenerId$$inline_442$$ = $element$$11$$["__" + $type$$50$$];
            if($handlers$$inline_440_listenerId$$inline_442$$ !== $JSCompiler_alias_VOID$$) {
              for(var $i$$inline_441$$ = $handlers$$inline_440_listenerId$$inline_442$$.length - 1;0 <= $i$$inline_441$$;) {
                $handlers$$inline_440_listenerId$$inline_442$$[$i$$inline_441$$] === $handler$$inline_439$$ && $handlers$$inline_440_listenerId$$inline_442$$.splice($i$$inline_441$$, 1), $i$$inline_441$$--
              }
            }
          }else {
            $handlers$$inline_440_listenerId$$inline_442$$ = $element$$11$$.$__ieTargetId$ + "_" + $type$$50$$, $handler$$inline_439$$[$handlers$$inline_440_listenerId$$inline_442$$] !== $JSCompiler_alias_VOID$$ && ($element$$11$$.detachEvent("on" + $type$$50$$, $handler$$inline_439$$[$handlers$$inline_440_listenerId$$inline_442$$]), delete $handler$$inline_439$$[$handlers$$inline_440_listenerId$$inline_442$$])
          }
        }
      }
...
$tuna$tmpl$units$Attribute$$.prototype.$__dispatchAttribute$ = function $$tuna$tmpl$units$Attribute$$$$$__dispatchAttribute$$() {
  for(var $i$$25$$ = this.$_nodes$.length - 1;0 <= $i$$25$$;) {
    var $element$$inline_444_element$$inline_81$$ = this.$_nodes$[$i$$25$$], $type$$inline_82$$ = this.$__attributeName$, $event$$inline_445_event$$inline_83$$ = $JSCompiler_alias_NULL$$;
    if(document.createEventObject !== $JSCompiler_alias_VOID$$) {
      var $event$$inline_445_event$$inline_83$$ = document.createEventObject(), $eventName$$inline_84$$ = "on" + $type$$inline_82$$;
      $element$$inline_444_element$$inline_81$$[$eventName$$inline_84$$] === $JSCompiler_alias_VOID$$ ? ($event$$inline_445_event$$inline_83$$.$__type$ = $type$$inline_82$$, $element$$inline_444_element$$inline_81$$.fireEvent("onhelp", $event$$inline_445_event$$inline_83$$)) : $element$$inline_444_element$$inline_81$$.fireEvent($eventName$$inline_84$$, $event$$inline_445_event$$inline_83$$)
    }else {
      $event$$inline_445_event$$inline_83$$ = document.createEvent("UIEvents"), $event$$inline_445_event$$inline_83$$.initUIEvent($type$$inline_82$$, $JSCompiler_alias_TRUE$$, $JSCompiler_alias_TRUE$$, window, 1), $element$$inline_444_element$$inline_81$$.dispatchEvent($event$$inline_445_event$$inline_83$$)
    }
    $i$$25$$--
  }
};
...
$JSCompiler_prototypeAlias$$.init = function $$JSCompiler_prototypeAlias$$$init$() {
  ...
  $tuna$dom$addEventListener$$(this.$_target$, "submit", function($event$$21$$) {
    $self$$7$$.isEnabled() ? ($callbackInput$$.value = "form_callback" + (Math.random() + "").substr(2), window[$callbackInput$$.value] = function $window$$callbackInput$$$value$($data$$inline_180_errors$$inline_182_response$$) {
      var $data$$inline_180_errors$$inline_182_response$$ = JSON.parse(JSON.stringify($data$$inline_180_errors$$inline_182_response$$)), $i$$inline_456_response$$inline_181$$ = $data$$inline_180_errors$$inline_182_response$$.response, $data$$inline_180_errors$$inline_182_response$$ = $data$$inline_180_errors$$inline_182_response$$.errors;
      if($i$$inline_456_response$$inline_181$$ !== $JSCompiler_alias_VOID$$) {
        $self$$7$$.$__recordName$ !== $JSCompiler_alias_NULL$$ && ($i$$inline_456_response$$inline_181$$ = $tuna$rest$populateRecords$$($i$$inline_456_response$$inline_181$$, $self$$7$$.$__recordName$)), $self$$7$$.$dispatch$("result", $i$$inline_456_response$$inline_181$$)
      }else {
        if($data$$inline_180_errors$$inline_182_response$$ !== $JSCompiler_alias_VOID$$) {
          for(var $i$$inline_456_response$$inline_181$$ = 0, $l$$inline_457$$ = $data$$inline_180_errors$$inline_182_response$$.length, $error$$inline_458_name$$inline_488$$ = $JSCompiler_alias_NULL$$;$i$$inline_456_response$$inline_181$$ < $l$$inline_457$$;) {
            $error$$inline_458_name$$inline_488$$ = $data$$inline_180_errors$$inline_182_response$$[$i$$inline_456_response$$inline_181$$];
            if($error$$inline_458_name$$inline_488$$.param !== $JSCompiler_alias_VOID$$) {
              var $JSCompiler_StaticMethods___showInputError$self$$inline_459_JSCompiler_StaticMethods_showErrorMessage$self$$inline_493$$ = $self$$7$$, $message$$inline_460_message$$inline_494$$ = $error$$inline_458_name$$inline_488$$.message, $JSCompiler_StaticMethods___getFormInput$self$$inline_487_formInput$$inline_461$$;
              $JSCompiler_StaticMethods___getFormInput$self$$inline_487_formInput$$inline_461$$ = $JSCompiler_StaticMethods___showInputError$self$$inline_459_JSCompiler_StaticMethods_showErrorMessage$self$$inline_493$$;
              var $error$$inline_458_name$$inline_488$$ = $error$$inline_458_name$$inline_488$$.param, $result$$inline_489$$ = $JSCompiler_alias_NULL$$;
              if($JSCompiler_StaticMethods___getFormInput$self$$inline_487_formInput$$inline_461$$.$__inputTable$[$error$$inline_458_name$$inline_488$$] === $JSCompiler_alias_VOID$$) {
                var $input$$inline_491_inputWrapper$$inline_490$$ = $tuna$dom$selectOne$$(".j-" + $error$$inline_458_name$$inline_488$$ + "-input", $JSCompiler_StaticMethods___getFormInput$self$$inline_487_formInput$$inline_461$$.$_target$);
                $input$$inline_491_inputWrapper$$inline_490$$ !== $JSCompiler_alias_NULL$$ && ($input$$inline_491_inputWrapper$$inline_490$$ = new $tuna$ui$forms$FormInput$$($input$$inline_491_inputWrapper$$inline_490$$), $input$$inline_491_inputWrapper$$inline_490$$.init(), $JSCompiler_StaticMethods___getFormInput$self$$inline_487_formInput$$inline_461$$.$__inputTable$[$error$$inline_458_name$$inline_488$$] = $input$$inline_491_inputWrapper$$inline_490$$)
              }
              $JSCompiler_StaticMethods___getFormInput$self$$inline_487_formInput$$inline_461$$.$__inputTable$[$error$$inline_458_name$$inline_488$$] !== $JSCompiler_alias_VOID$$ && ($result$$inline_489$$ = $JSCompiler_StaticMethods___getFormInput$self$$inline_487_formInput$$inline_461$$.$__inputTable$[$error$$inline_458_name$$inline_488$$]);
              $JSCompiler_StaticMethods___getFormInput$self$$inline_487_formInput$$inline_461$$ = $result$$inline_489$$;
              $JSCompiler_StaticMethods___getFormInput$self$$inline_487_formInput$$inline_461$$ !== $JSCompiler_alias_NULL$$ ? ($JSCompiler_StaticMethods___showInputError$self$$inline_459_JSCompiler_StaticMethods_showErrorMessage$self$$inline_493$$ = $JSCompiler_StaticMethods___getFormInput$self$$inline_487_formInput$$inline_461$$, $tuna$dom$addClass$$($JSCompiler_StaticMethods___showInputError$self$$inline_459_JSCompiler_StaticMethods_showErrorMessage$self$$inline_493$$.$_target$, "error"), $JSCompiler_StaticMethods___showInputError$self$$inline_459_JSCompiler_StaticMethods_showErrorMessage$self$$inline_493$$.$__message$ !== 
              $JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods___showInputError$self$$inline_459_JSCompiler_StaticMethods_showErrorMessage$self$$inline_493$$.$__message$.innerHTML = $message$$inline_460_message$$inline_494$$)) : $JSCompiler_StaticMethods___showErrorMessage$$($JSCompiler_StaticMethods___showInputError$self$$inline_459_JSCompiler_StaticMethods_showErrorMessage$self$$inline_493$$, $message$$inline_460_message$$inline_494$$)
            }else {
              $JSCompiler_StaticMethods___showErrorMessage$$($self$$7$$, $error$$inline_458_name$$inline_488$$.message)
            }
            $i$$inline_456_response$$inline_181$$++
          }
...
function $JSCompiler_StaticMethods___prepareTo$$($JSCompiler_StaticMethods___prepareTo$self$$, $JSCompiler_StaticMethods_cleanup$self$$inline_463_type$$73$$, $event$$23$$) {
  if($JSCompiler_StaticMethods___prepareTo$self$$.$dispatch$($JSCompiler_StaticMethods_cleanup$self$$inline_463_type$$73$$)) {
    ...
    for(var $name$$inline_187$$ in $JSCompiler_StaticMethods___prepareTo$self$$.$__inputTable$) {
      $JSCompiler_StaticMethods_cleanup$self$$inline_463_type$$73$$ = $JSCompiler_StaticMethods___prepareTo$self$$.$__inputTable$[$name$$inline_187$$], $tuna$dom$removeClass$$($JSCompiler_StaticMethods_cleanup$self$$inline_463_type$$73$$.$_target$, "error"), $JSCompiler_StaticMethods_cleanup$self$$inline_463_type$$73$$.$__message$ !== $JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods_cleanup$self$$inline_463_type$$73$$.$__message$.innerHTML = $JSCompiler_StaticMethods_cleanup$self$$inline_463_type$$73$$.$__defaultMessage$)
    }
  }else {
...
$tuna$ui$selection$Navigation$$.prototype.init = function $$tuna$ui$selection$Navigation$$$$init$() {
  ...
  var $buttonSelector$$inline_229_buttons$$inline_231_currentIndex$$inline_237_itemsCollection$$inline_224$$ = new $tuna$ui$selection$items$NamedElementsCollection$$("data-name"), $i$$inline_232_menu$$inline_230_menuSelector$$inline_228_selectionView$$inline_225$$ = new $tuna$ui$selection$view$ClassSelectionView$$(this.$_target$), $className$$inline_466_l$$inline_233_selector$$inline_469$$ = $JSCompiler_StaticMethods_getStringOption$$(this, "selection-class");
  $i$$inline_232_menu$$inline_230_menuSelector$$inline_228_selectionView$$inline_225$$.$_selectionClass$ = $className$$inline_466_l$$inline_233_selector$$inline_469$$;
  $className$$inline_466_l$$inline_233_selector$$inline_469$$ = $JSCompiler_StaticMethods_getStringOption$$(this, "item-selector");
  $i$$inline_232_menu$$inline_230_menuSelector$$inline_228_selectionView$$inline_225$$.$_itemSelector$ = $className$$inline_466_l$$inline_233_selector$$inline_469$$;
...
function $JSCompiler_StaticMethods___initControls$$($JSCompiler_StaticMethods___initControls$self$$) {
  ...
  $controls$$.addEventListener("navigate", function($event$$26$$, $button$$2$$) {
    ...
    if($index$$66$$ !== $JSCompiler_alias_NULL$$) {
      for(var $result$$inline_481$$ = {}, $attrs$$inline_482$$ = $button$$2$$.$_target$.attributes, $i$$inline_483$$ = 0, $l$$inline_484$$ = $attrs$$inline_482$$.length;$i$$inline_483$$ < $l$$inline_484$$;) {
        0 === $attrs$$inline_482$$[$i$$inline_483$$].name.indexOf("data-") && ($result$$inline_481$$[$attrs$$inline_482$$[$i$$inline_483$$].name.substr(5)] = $attrs$$inline_482$$[$i$$inline_483$$].value), $i$$inline_483$$++
      }
      delete $result$$inline_481$$.href;
      $JSCompiler_StaticMethods___initControls$self$$.navigate($index$$66$$, $result$$inline_481$$)
    }
  });
